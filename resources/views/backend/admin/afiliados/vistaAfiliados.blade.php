    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header" id="card-header-color">
                <h3 class="card-title" style="color: white">Listado de Propietarios</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/afiliados/tabla/lista') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/afiliados/tabla/lista') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function informacion(id){
            ...
            axios.post('/admin/afiliados/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post('/admin/afiliados/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
