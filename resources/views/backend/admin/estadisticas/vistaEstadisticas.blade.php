                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box bg-info">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Ordenes Hoy: </span>
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box bg-gray-dark">
                                <span class="info-box-icon"><i class="fas fa-shopping-cart" style="color: white"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Venta Total Hoy</span>
                                    <span class="info-box-number">0000</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box bg-gray">
                                <span class="info-box-icon"><i class="fas fa-money-bill" style="color: white"></i></span>
                                <div class="info-box-content">
